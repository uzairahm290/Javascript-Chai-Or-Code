...
// number.toPrecision(3) => 123.896 -> 124  , 1123.987 -> 123e1 
// Math.random
// Imp => (Math.floor(Math.random() * (max - min + 1)) + min ) //to get random values in a specific range
...
// Slice => get elements from an array and not includes end index 
// Splice => not get -> extract elements from array means change original array and includes end index
